module.exports.routes = {
  ...
  // STATUS/STATUS
  'GET     /status/all'                 : 'StatusController.getAll', // GetAll/ListarTodos
  'POST    /status/create'              : 'StatusController.create', // Create/Criar
  'PUT     /status/update'              : 'StatusController.update', // Update/Atualizar
  'DELETE  /status/delete/:id'          : 'StatusController.delete', // Delete/Deletar
  ...
  'GET     /scheduling/all'               : 'SchedulingController.getAll'      ,// GetAll/ListarTodos
  'GET     /scheduling/byId/:id'          : 'SchedulingController.getAllById'  ,// GetById/ListarPorId
  'POST    /scheduling/create'            : 'SchedulingController.create'      ,// Create/Criar
  'PUT     /scheduling/update'            : 'SchedulingController.update'      ,// Update/Atualizar
  'PUT     /scheduling/status'            : 'SchedulingController.updateStatus',// Update/AtualizarStatus
  'DELETE  /scheduling/delete/:id'        : 'SchedulingController.delete'      ,// Delete/Deletar
};
